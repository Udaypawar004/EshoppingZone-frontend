...
import { DarkModeService } from "src/app/services/DarkModeService";
...
@Component({
    ...
    template: `
      <button 
        (click)="toggleTheme()" 
        class="relative p-2 transition-all duration-300 hover:scale-105"
      >
        ...
        <div class="text-gray-700 text-xs font-bold pt-1 dark:text-gray-300">
